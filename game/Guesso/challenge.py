...
def load_model():
    ...
    try:
        ...
        print("Error loading model", errs)
        exit(1)
...
def word_guess_challenge():
    ...
    print("You have 5 attempts to guess the word based on the similarity hint")
    ...
    for attempt in range(1, 6):
        while True:
            ...
            try:
                ...
                if user_guess in words:
                    ...
                    print(
                        "Error: The entered word is not in the model vocabulary. Try another word.")
        ...
        if user_guess == target_word:
            print(
                f"Congratulations! You guessed the correct word '{target_word}' in {attempt} attempts.")
